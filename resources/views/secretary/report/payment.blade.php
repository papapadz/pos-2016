                ...
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-right" style="background-color: #e5e4e4;">
                            {!! Form::open(['route'=>'secretaryReportPaymentIndex', 'method'=>'get', 'class'=>'uk-form']) !!}
                            ...
                            <a href="{{ route('secretaryReportPaymentPrint', ['option'=>$option, 'month'=>$monthSel, 'year'=>$yearSel]) }}" target="_blank" class="uk-button uk-button-success">Print Report</a>
                            {!! Form::close() !!}
                        </div>
