                ...
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <div style="padding-left: 15px; padding-right: 15px; margin-bottom: 15px;">
                            {!! Form::model($supplier, ['route'=>['secretarySupplierUpdate', 'id'=>$supplier->supplier_id], 'method'=>'patch', 'class'=>'uk-form uk-form-stacked']) !!}
                            @include('secretary.supplier._form', ['btnCaption'=>'Update Supplier Record'])
                            {!! Form::close() !!}
                        </div>
