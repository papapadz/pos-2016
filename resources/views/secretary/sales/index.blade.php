            ...
            <div class="uk-grid uk-grid-collapse">
                ...
                <div class="uk-width-4-10" style="padding-right: 5px;">
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary" style="background-color: #4E5255; color: #fff;">
                        ...
                        <div class="uk-text-bold  uk-text-right">
                            <a href="{{ route('secretaryProductsIndex')}}" class="uk-button"><i class="uk-icon-shopping-cart"></i></a></div>
                        <hr>
                        <div>

                            {!! Form::open(['route'=>'secretaryOrdersCreate', 'class'=>'uk-form']) !!}
                ...
                <div class="uk-width-6-10">
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td class="uk-text-right" width="10">
                                            <a href="{{ route('secretaryDestroyOrder', ['id'=>$order->order_id]) }}" class="uk-button uk-button-danger uk-button-mini del-rec"><i class="uk-icon-times"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                <tr>
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-margin-bottom uk-text-right">
                        {!! Form::open(['route'=>'secretarySalesCreate', 'method'=>'post']) !!}
