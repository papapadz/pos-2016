                        ...
                        <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-margin-small-top">
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-1-1 uk-text-center">
                                    <a href="{{ route('secretarySalesSummaryPrint', ['id'=>$sales->sales_id]) }}" target="_blank" class="uk-button uk-button-success">Print Invoice</a>
                                    <a href="{{ route('secretarySalesIndex') }}" class="uk-button uk-button-primary">Done</a>
                                </div>
                            </div>
                        </div>
