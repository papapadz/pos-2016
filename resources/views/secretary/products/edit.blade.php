                ...
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <div style="padding-left: 15px; padding-right: 15px; margin-bottom: 15px;">
                            {!! Form::model($product, ['route'=>['secretaryProductsUpdate', 'id'=>$product->product_id], 'method'=>'patch', 'class'=>'uk-form uk-form-stacked']) !!}
                            @include('secretary.products._form', ['btnCaption'=>'Update Product Record'])
                            {!! Form::close() !!}
                        </div>
