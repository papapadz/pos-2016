...
@section('content')
                ...
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-right" style="background-color: #e5e4e4;">
                            ...
                            <a href="{{ route('secretaryProductsCreate') }}" class="uk-button uk-button-primary"><i class="uk-icon-plus"></i> &nbsp;Create Product&nbsp;</a>
                            {!! Form::close() !!}
                        </div>
    ...
    <div id="reorder-modal" class="uk-modal">
        <div class="uk-modal-dialog">
            ...
            {!! Form::open(['url'=>'secretary/delivery/restock', 'method'=>'get', 'class'=>'uk-form uk-form-horizontal']) !!}
