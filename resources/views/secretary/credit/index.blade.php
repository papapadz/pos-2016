                            ...
                            <table class="uk-table uk-table-hover uk-table-striped">
                                ...
                                @if(count($credits) > 0)
                                    ...
                                    @foreach($credits as $credit)
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td><a href="{{ route('secretarySalesDetailsIndex', ['id'=>$credit->sales_id]) }}">{{ $credit->invoicenumber }}</a></td>
                                            ...
                                            <td class="uk-text-right">
                                                <a href="{{ route('secretaryCreditCreatePayment', ['id'=>$credit->sales_id]) }}" class="uk-button uk-button-success">Enter Payment</a>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                    @endforeach
