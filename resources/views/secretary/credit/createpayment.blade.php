                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary" style="background-color: #e5e4e4;">
                        <div class="uk-grid">
                            ...
                            <div class="uk-width-1-2 uk-text-right">
                                <a href="{{ route('secretaryCreditPaymentHistory', ['id'=>$sales->sales_id]) }}" class="uk-button uk-button-success">Payment History</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="uk-grid uk-grid-collapse">
                            ...
                            <div class="uk-width-4-10" style="padding-left: 5px;">
                                ...
                                <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-margin-small-top">
                                    ...
                                    {!! Form::open(['route'=>['secretaryCreditPaymentStore', 'sid'=>$sales->sales_id], 'class'=>'uk-form']) !!}
