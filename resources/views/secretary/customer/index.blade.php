        ...
        <div class="uk-width-1-1">
            ...
            <div style="margin-top:20px;">
                ...
                <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-right">
                    ...
                    <a href="{{ route('secretaryCustomerCreate') }}" class="uk-button uk-button-primary"><i class="uk-icon-plus"></i> Create Customer</a>
                </div>
                        ...
                        @if(count($customers) > 0)
                            @foreach($customers as $customer)
                                <tr>
                                    ...
                                    <td width="10">
                                        <a href="{{ route('secretaryTransactionsIndex', ['id'=>$customer->cust_id]) }}" class="uk-button uk-button-success uk-button-medium">Transactions</a>
                                    </td>
                                    <td class="uk-text-right">
                                        <a href="{{ route('secretaryCustomerEdit', ['id'=>$customer->cust_id]) }}" title="Edit"><i class="uk-icon-pencil"></i></a>
                                    </td>
