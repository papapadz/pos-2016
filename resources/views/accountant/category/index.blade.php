    ...
    <div class="uk-width-1-1">
        ...
        <div style="margin-top:20px;">
			...
			<div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-right" style="background-color: #e5e4e4;">
							...
							<a href="{{ route('accountantCategoryCreate') }}" class="uk-button uk-button-primary"><i class="uk-icon-plus"></i> Create Category</a>
            </div>
            ...
            <div class="uk-text-right uk-text-small uk-text-primary">
                <i>{{ count($categories) }} - Category record found</i>
            </div>
            <div>
                @include('paginator', ['paginator' => $categories])
            </div>
