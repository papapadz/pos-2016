                ...
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-right" style="background-color: #e5e4e4;">
                            {!! Form::open(['route'=>'accountantReportIndex', 'method'=>'get', 'class'=>'uk-form']) !!}
                            ...
                            <a href="{{ route('accountantReportPrint', ['option'=>$option, 'day'=>$daySel, 'month'=>$monthSel]) }}" target="_blank" class="uk-button uk-button-success">Print Report</a>
                            {!! Form::close() !!}
                        </div>
                            ...
                            <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-right">
                                <table width="100%">
                                    ...
                                    <tr class="uk-text-large">
                                        ...
                                        <td width="135" style="text-align: right;"><strong>{{ number_format($total - $cash, 2) }}</strong></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr class="uk-text-large">
                                        <td colspan="3" class="uk-text-right"><strong>Total Cash:</strong></td>
                                        <td width="135" style="text-align: right;"><strong>{{ number_format($cash, 2) }}</strong></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </table>
                            </div>
