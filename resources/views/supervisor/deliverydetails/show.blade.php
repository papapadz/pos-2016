                ...
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-right" style="background-color: #e5e4e4;">
                            <a href="{{ route('supervisorDeliveryIndex') }}" class="uk-button uk-button-primary">Done</a>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @endforeach
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5" style="text-align: right"><strong> Total Amount: &nbsp;&nbsp;&nbsp;{{ number_format($delivery->totalcost, 2) }}</strong></td>
                                            </tr>
