                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>{{ $customer->firstname }} {{ $customer->lastname }}</td>
                                        <!--<a href="{{ route('supervisorSalesEdit') }}"><i class="uk-text-left uk-icon-pencil"></i></a> -->
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-margin-small-top">
                        ...
                        <div class="uk-grid">
                            <div class="uk-width-1-1 uk-text-center">
                                <a href="{{ route('supervisorSalesDetailsPrint', ['id'=>$sales->sales_id]) }}" target="_blank" class="uk-button uk-button-success">Print Invoice</a>
                                <a href="{{ route('supervisorTransactionsIndex', ['id'=>$customer->cust_id]) }}" class="uk-button uk-button-primary">Done</a>
                            </div>
                        </div>
