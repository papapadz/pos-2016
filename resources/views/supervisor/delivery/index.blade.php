            ...
            <div class="uk-grid uk-grid-collapse">
                ...
                <div class="uk-width-4-10" style="padding-left: 5px;">
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary" style="background-color: #4E5255; color: #fff;">
                        ...
                        <div>
                            ...
                            {!! Form::open(['route'=>'supervisorDeliverySetStore', 'class'=>'uk-form']) !!}
                ...
                <div class="uk-width-6-10">
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-margin-small-top uk-margin-small-bottom" style="min-height: 250px; background-color: #fafafa;">
                        <table class="uk-table uk-table-hover uk-table-condensed">
                            ...
                            <tr style="background-color: #4E5255; color: #fff;">
                                ...
                                <th>Item</th>
                                <th>Quantity</th>
                                <th style="text-align: right">Unitcost <i class="uk-icon-rub uk-text-small"></i></th>
                                    ...
                                    <tbody>
                                        @foreach($deliverysets as $deliveryset)
                                            <tr>
                                                ...
                                                <td>&nbsp;</td>
                                                <td width="10">
                                                    <a href="{{ route('supervisorDestroyDelivery-set', ['id'=>$deliveryset->deliveryset_id]) }}" class="uk-button uk-button-danger uk-button-mini del-rec"><i class="uk-icon-times"></i></a>
                                                </td>
                                            </tr>
                                        ...
                                        @else
                                            <tr style="background-color: #F0F0F0;">
                                                <td colspan="5"><i class="uk-text-small">Ready...</i></td>
                                            </tr>
                                    </tbody>
                                @endif
                        </table>
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-margin-bottom uk-text-right">
                        {!! Form::open(['route'=>'supervisorDeliveryStore', 'id'=>'frm-process-deliveries', 'class'=>'uk-form']) !!}
                ...
                <table class="uk-table uk-table-hover uk-table-striped">
                    ...
                    @if(count($deliveries) > 0)
                        ...
                        @foreach($deliveries as $delivery)
                            <tr>
                                <td>&nbsp;</td>
                                <td><a href="{{ route('supervisorDeliveryDetailsShow', $delivery->delivery_id) }}"</a>{{ substr($delivery->deliverydate, 0, 10) }}</td>
                                <td>{{ $delivery->mySupplier->companyname }}</td>
                                <td style="text-align: right">{{ number_format($delivery->totalcost, 2) }}</td>
                                <td>&nbsp;</td>
                                <td>
                                    <a href="{{ route('supervisorDeliveryEdit', ['id'=>$delivery->delivery_id]) }}"><i class="uk-icon-pencil"></i></a>
                                </td>
