        ...
        <div style="background-color: #FFF; padding: 3px;">
            ...
            <div class="uk-grid uk-grid-collapse">
                ...
                <div class="uk-width-4-10" style="padding-right: 5px;">
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary" style="background-color: #e59100; color: #fff;">
                        <div class="uk-text-bold">Sales Management</div>
                        <div class="uk-text-bold  uk-text-right">
                            <a href="{{ route('supervisorProductsIndex')}}" class="uk-button"><i class="uk-icon-shopping-cart"></i></a></div>
                        <hr>
                        <div>

                            {!! Form::open(['route'=>'supervisorOrdersCreate', 'class'=>'uk-form']) !!}
                ...
                <div class="uk-width-6-10">
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-margin-small-top uk-margin-small-bottom" style="min-height: 250px; background-color: #fafafa;">
                        <table class="uk-table uk-table-hover uk-table-condensed">
                            <thead>
                            <tr style="background-color: #e59100; color: #fff;">
                                <th>&nbsp;</th>
                                <th>Item</th>
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td class="uk-text-right" width="10">
                                            <a href="{{ route('supervisorDestroyOrder', ['id'=>$order->order_id]) }}" class="uk-button uk-button-danger uk-button-mini del-rec"><i class="uk-icon-times"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                <tr>
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-margin-bottom uk-text-right">
                        {!! Form::open(['route'=>'supervisorSalesCreate', 'method'=>'post']) !!}
