            ...
            <div class="uk-grid uk-grid-collapse">
                ...
                <div class="uk-width-1-1">
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary">
                        <div class="uk-grid">
                            <div class="uk-width-1-2">
                                {!! Form::open(['route'=>'supervisorSalesCreditPayment', 'method'=>'post', 'class'=>'uk-form']) !!}
                    ...
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-margin-small-top">
                        ...
                        {!! Form::open(['route'=>['supervisoralesCreditPaymentCreate', 'sid'=>$sales->sales_id], 'class'=>'uk-form']) !!}
                        <div>
                            <strong>OR NUMBER:</strong> <span>{{ $sales->invoicenumber }}</span>
                            <a href="{{ route('supervisorSalesPaymentHistory', ['id'=>$sales->sales_id]) }}" class="uk-text-small">Payment History</a>
                        </div>
