                ...
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <div style="padding-left: 15px; padding-right: 15px; margin-bottom: 15px;">
                            {!! Form::model($customer, ['route'=>['supervisorCustomerUpdate', 'id'=>$customer->cust_id], 'method'=>'patch', 'class'=>'uk-form uk-form-stacked']) !!}
                            @include('supervisor.customer._form', ['btnCaption'=>'Update Customer Record'])
                            {!! Form::close() !!}
                        </div>
