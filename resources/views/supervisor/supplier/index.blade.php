                ...
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:20px;">
                        ...
                        <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-right" style="background-color: #e5e4e4;">
                            ...
                            <a href="{{ route('supervisorSupplierCreate') }}" class="uk-button uk-button-primary"><i class="uk-icon-plus"></i> Create Supplier</a>
                                ...
                                @if(count($suppliers) > 0)
                                    ...
                                    @foreach($suppliers as $supplier)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('supervisorSupplierEdit', ['id'=>$supplier->supplier_id]) }}"><i class="uk-icon-pencil"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
