                ...
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-right" style="background-color: #e5e4e4;">
                            ...
                            <a href="{{ route('supervisorCategoryCreate') }}" class="uk-button uk-button-primary"><i class="uk-icon-plus"></i> Create Category</a>
                        </div>
                                ...
                                @if(count($categories) > 0)
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('supervisorCategoryEdit', ['id'=>$category->category_id]) }}"><i class="uk-text-left uk-icon-pencil"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
