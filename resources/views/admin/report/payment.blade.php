                ...
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-text-right" style="background-color: #e5e4e4;">
                            {!! Form::open(['route'=>'reportPaymentIndex', 'method'=>'get', 'class'=>'uk-form']) !!}
                            ...
                            <a href="{{ route('reportPaymentPrint', ['option'=>$option, 'month'=>$monthSel, 'year'=>$yearSel]) }}" target="_blank" class="uk-button uk-button-success">Print Report</a>
                            {!! Form::close() !!}
                        </div>
                        ...
                        <div class="uk-panel uk-panel-box uk-panel-box-secondary uk-margin-small-top">
                            <table class="uk-table uk-table-hover uk-table-striped">
                                ...
                                <!--        <th style="background-color: #464646; color: #fff; text-align: right;">Payment Mode</th>        -->
                                        <th style="background-color: #464646; color: #fff;">&nbsp;</th>
                                    @else
                                        <th style="background-color: #464646; color: #fff; text-align: right;">Total Sales Amount</th>
                                ...
                                @if(count($reports) > 0)
                                    @foreach($reports as $report)
                                        <tr>
                                            ...
                                            <td>{{ $report->myCustomer->companyname }} -- {{ $report->myCustomer->lastname }}</td>
                                            @if($option == 1)
                                                <td style="text-align: right;">{{ number_format($report->myPayments()->first()->amountpaid, 2) }}</td>
