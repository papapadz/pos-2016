            ...
            <div class="uk-grid">
                <div class="uk-width-1-1">
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <h2>New Expenses Details</h2>

                        <hr>

                        <div style="padding-left: 15px; padding-right: 15px; margin-bottom: 15px;">
                            {!! Form::open(['route'=>'expensesStore', 'method'=>'post', 'class'=>'uk-form uk-form-stacked']) !!}
                            @include('admin.expenses._form', ['btnCaption'=>'Create Expenses Record'])
                            {!! Form::close() !!}
                        </div>
