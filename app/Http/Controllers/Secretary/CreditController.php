...
class CreditController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('secretary.credit.index', compact('credits', 'skey'));
    }
    ...
    public function createPayment($id)
    {
        ...
        return view('secretary.credit.createpayment', compact('customer', 'invoiceNumber', 'payment', 'sales', 'salesDetails', 'vatSales', 'vat', 'grandTotal'));
    }
    ...
    public function storePayment(Request $request)
    {
        ...
        return redirect()->route('secretaryCreditIndex')->with(['code'=>'1']);
    }
    ...
    public function paymentHistory($id)
    {
        ...
        return view('secretary.credit.history', compact('salesPayment'));
    }
