...
class ReportsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('secretary.report.index', compact('months', 'monthSel', 'daySel', 'reports', 'sumSales', 'sumCredit', 'sumCash', 'option'));
    }
    ...
    public function printReport($option, $day, $month)
    {
        ...
        return view('secretary.report.print', compact('reports', 'reportStart', 'sumSales', 'sumCredit', 'sumCash', 'reportEnd'));
    }
    ...
    public function inventory(Request $request)
    {
        ...
        return view('secretary.report.inventory', compact('catSel', 'reports', 'categories', 'totalInventoryValue'));
    }
    ...
    public function printInventoryReport($category)
    {
        ...
        return view('secretary.report.printinventory', compact('reports', 'totalInventoryValue', 'catSel'));
    }
    ...
    public function sales(Request $request)
    {
        ...
        return view('secretary.report.sales', compact('months', 'years', 'monthSel', 'yearSel', 'reports', 'optSel'));
    }
    ...
    public function salesPrint($option, $year, $month)
    {
        ...
        return view('secretary.report.salesprint', compact('reports', 'option'));
    }
    ...
    public function customers(Request $request)
    {
        ...
        return view('secretary.report.customer', compact('reports'));
    }
    ...
    public function customerSales(Request $request, $id)
    {
        ...
        return view('secretary.report.customersales', compact('reports', 'id', 'dateSel'));
    }
    ...
    public function customerSalesPrint($date, $id)
    {
        ...
        return view('secretary.report.customersalesprint', compact('reports', 'customer'));
    }
    ...
    public function payment(Request $request)
    {
        ...
        return view('secretary.report.payment', compact('reports', 'option', 'months', 'monthSel', 'yearSel', 'years'));
    }
    ...
    public function paymentPrint($option, $month, $year)
    {
        ...
        return view('secretary.report.paymentprint', compact('reports', 'option'));
    }
    ...
    public function delivery(Request $request)
    {
        ...
        return view('secretary.report.delivery', compact('months', 'monthDel', 'dayDel', 'reports', 'option', 'totalCost'));
    }
    ...
    public function deliveryPrint($option, $day, $month)
    {
        ...
        return view('secretary.report.deliveryPrint', compact('reports', 'reportStart', 'reportEnd', 'totalCost'));
    }
    ...
    public function stat(Request $request)
    {
        ...
        return view('secretary.report.stat', compact('reports', 'overallCtr'));
    }
    ...
    public function statPrint($option, $month)
    {
        ...
        return view('secretary.report.printStat', compact('reports', 'overallCtr'));
    }
...
/*
        ...
        return view('secretary.report.incomestatement', compact('monthSel', 'yearSel', 'months', 'years', 'grossSales', 'deliveryCost'));
    }
    ...
    public function incomeStatementPrint($month, $year)
    {
        ...
        return view('secretary.report.printincomestatement', compact('monthSel', 'yearSel', 'months', 'years', 'grossSales', 'deliveryCost'));
    }
