...
class SalesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('secretary.sales.index', compact('orders', 'categories', 'customers', 'vatSales', 'vat', 'grandTotal', 'markUpArr'));
    }
    ...
    public function paymentHistory($id)
    {
        ...
        return view('secretary.sales.history', compact('salesPayment'));
    }
    ...
    public function credit(Request $request)
    {
        ...
        return view('secretary.sales.credit', compact('customer', 'invoiceNumber', 'payment', 'sales', 'salesDetails', 'vatSales', 'vat', 'grandTotal'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return redirect()->route('secretarySalesSummary', ['id'=>$sales->sales_id]);
    ...
    public function summary($id)
    {
        ...
        return view('secretary.sales.summary', compact('salesDetails', 'customer', 'sales', 'vatSales', 'vat', 'grandTotal'));
    }
    ...
    public function printSummary($id)
    {
        ...
        return view('secretary.sales.printsummary', compact('salesDetails', 'customer', 'sales', 'vatSales', 'vat', 'grandTotal'));
    }
    ...
    public function creditPaymentCreate(Request $request)
    {
        ...
        return redirect()->route('secretarySalesIndex')->with(['code'=>'1']);
    }
    ...
    public function editCustomer($id)
    {
        ...
        return view('secretary.sales.edit', compact('sales', 'customers'));
    }
     ...
     public function updateCustomer(SalesRequest $request, $id)
    {
        ...
        return redirect()->route('secretarySalesDetailsIndex');
    }
    ...
    public function edit($id)
    {
        ...
        return view('secretary.sales.summary', compact('salesDetails', 'customer', 'sales'));
    }
