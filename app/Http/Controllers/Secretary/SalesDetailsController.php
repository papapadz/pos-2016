...
class SalesDetailsController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('secretary.salesdetails.index', compact('salesDetails', 'customer', 'sales', 'vatSales', 'vat', 'grandTotal'));
    }
    ...
    public function printInvoice($id)
    {
        ...
        return view('secretary.salesdetails.print', compact('salesDetails', 'customer', 'sales', 'vatSales', 'vat', 'grandTotal'));
    }
}
