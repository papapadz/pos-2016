...
class ProductsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('secretary.products.index', compact('products', 'suppliers', 'status', 'skey'));

        #return view('secretary.products.index', compact('products', 'suppliers', 'status'));
    }
    ...
    public function create()
    {
        ...
        return view('secretary.products.create', compact('categories', 'reorderlimit', 'markup', 'suppliers'));
    }
    ...
    public function store(ProductRequest $request)
    {
        ...
        return redirect()->route('secretaryProductsIndex');
    }
    ...
    public function edit($id)
    {
        ...
        return view('secretary.products.edit', compact('product', 'reorderlimit', 'markup', 'categories', 'suppliers'));
    }
