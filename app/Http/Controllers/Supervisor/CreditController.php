...
class CreditController extends Controller
{
    ...
    public function index(Request $request)
    {
       $skey = ($request->skey == '' || $request->skey == null) ? null : $request->skey;
        ...
        return view('supervisor.credit.index', compact('credits', 'skey'));
    }
    ...
    public function createPayment($id)
    {
        ...
        return view('supervisor.credit.createpayment', compact('customer', 'invoiceNumber', 'payment', 'sales', 'salesDetails', 'vatSales', 'vat', 'grandTotal'));
    }
    ...
    public function storePayment(Request $request)
    {
        ...
        return redirect()->route('supervisorCreditIndex')->with(['code'=>'1']);
    }
    ...
    public function paymentHistory($id)
    {
        ...
        return view('supervisor.credit.history', compact('salesPayment'));
    }
