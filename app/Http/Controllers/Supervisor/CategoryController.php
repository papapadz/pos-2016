...
class CategoryController extends Controller
{
     ...
     public function index(Request $request)
    {
        ...
        return view('supervisor.category.index', compact('categories', 'skey'));
    }
    ...
    {
        return view('supervisor.category.create');
    }
    ...
    public function store(CategoryRequest $request)
    {
        ...
        return redirect()->route('supervisorCategoryIndex');
    }
    ...
    public function edit($id)
    {
        ...
        return view('supervisorCategory.edit', compact('category'));
    }
