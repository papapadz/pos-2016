...
class SalesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('supervisor.sales.index', compact('orders', 'categories', 'customers', 'vatSales', 'vat', 'grandTotal', 'markUpArr'));
    }
    ...
    public function paymentHistory($id)
    {
        ...
        return view('supervisor.sales.history', compact('salesPayment'));
    }
    ...
    public function credit(Request $request)
    {
        ...
        return view('supervisor.sales.credit', compact('customer', 'invoiceNumber', 'payment', 'sales', 'salesDetails', 'vatSales', 'vat', 'grandTotal'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return redirect()->route('supervisorSalesSummary', ['id'=>$sales->sales_id]);
    ...
    public function summary($id)
    {
        ...
        return view('supervisor.sales.summary', compact('salesDetails', 'customer', 'sales', 'vatSales', 'vat', 'grandTotal'));
    }
    ...
    public function printSummary($id)
    {
        ...
        return view('supervisor.sales.printsummary', compact('salesDetails', 'customer', 'sales', 'vatSales', 'vat', 'grandTotal'));
    }
    ...
    public function creditPaymentCreate(Request $request)
    {
        ...
        return redirect()->route('supervisorSalesIndex')->with(['code'=>'1']);
    }
    ...
    public function editCustomer($id)
    {
        ...
        return view('supervisor.sales.edit', compact('sales', 'customers'));
    }
     ...
     public function updateCustomer(SalesRequest $request, $id)
    {
        ...
        return redirect()->route('supervisorSalesDetailsIndex');
    }
    ...
    public function edit($id)
    {
        ...
        return view('supervisor.sales.summary', compact('salesDetails', 'customer', 'sales'));
    }
