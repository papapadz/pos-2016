...
class SalesDetailsController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('supervisor.salesdetails.index', compact('salesDetails', 'customer', 'sales', 'vatSales', 'vat', 'grandTotal'));
    }
    ...
    public function printInvoice($id)
    {
        ...
        return view('supervisor.salesdetails.print', compact('salesDetails', 'customer', 'sales', 'vatSales', 'vat', 'grandTotal'));
    }
}
