...
class DeliveryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('supervisor.delivery.index', compact('deliveries', 'deliverysets', 'suppliers', 'totDeliveryCost', 'products', 'selSupplier', 'selDate'));
    }
    ...
    public function create()
    {
        ...
        return view('supervisor.delivery.create', compact('suppliers', 'products'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('supervisor.delivery.edit', compact('delivery', 'deliveryArr', 'suppliers', 'products'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('supervisorDeliveryIndex');
    }
