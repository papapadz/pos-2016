...
class CustomerController extends Controller
{
    ...
    {  
        ...
        return view('accountant.customer.index', compact('customers', 'skey'));
    }
    ...
    public function create()
    {
        ...
        return view('accountant.customer.create', compact('customerType'));
    }
    ...
    public function store(CustomerRequest $request)
    {
        ...
        return redirect()->route('accountantCustomerIndex');
    }
    ...
    public function edit($id)
    {
        ...
        return view('accountant.customer.edit', compact('customer', 'customerType'));
    }
