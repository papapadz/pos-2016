...
class ReportsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.report.index', compact('dateToFormat', 'months', 'monthSel', 'daySel', 'reports', 'sumSales', 'sumCredit', 'sumCash', 'option'));
    }
    ...
    public function custAgent($id)
    {
        ...
        $customers = Customer::where('cust_type', $id)->orderby('lastname', 'asc')->get();
       ...
       if(is_null($customers))
        ...
        return view('admin.report.custAgent', compact('dateToFormat', 'customers', 'reports', 'customerType', 'agents'));
    }
